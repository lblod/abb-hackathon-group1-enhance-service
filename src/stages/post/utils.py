...
def insert_heritage_objects(heritage_objects: list[dict[int, list[dict]]]):
    """
    ...
    for heritage_object in heritage_objects:
        for heritage_object_id, rules in heritage_object.items():
            ...
            for rule_entry in rules:
                ...
                source_uri = sparql_escape_uri(
                    f"https://id.erfgoed.net/besluiten/{source}")  # hard-coded besluit for now --> should be different based on source_type
